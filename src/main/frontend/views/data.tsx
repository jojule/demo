    ...
    return (
        <div className="flex flex-col">
            ...
            additionalOptions={{
                ...
                }, "yAxis": {"title": {"text": "Energy Consumption (kWh)"}}
            }}>

            <ChartSeries title="2023"
                         values={[1450000, 1400000, 1350000, 1320000, 1250000, 1200000, 1150000, 1180000, 1220000, 1260000, 1300000, 1350000]}/><ChartSeries
            title="2024"
            values={[1500000, 1450000, 1380000, 1350000, 1300000, 1250000, 1200000, 1230000, 1270000, 1300000, 1350000, 1400000]}/>
        </Chart>
        </div>
    );
}
